      ...
      <div className="md:flex justify-between my-10">
        ...
        <div className="flex justify-between items-center gap-5">
          ...
          {isInstructor(user) ? (
            ...
            <p className="text-base text-xl text-gray-900 dark:text-white">
              {_duration} {_duration > 1 ? "minutes" : "minute"}
            </p>
          )}
        </div>
      </div>
          ...
          <Card key={question.id} className="w-full">
            <div className="flex flex-col gap-4 w-full">
              ...
              {isInstructor(user) ? (
                ...
                <p className="text-base text-lg text-left text-gray-900 dark:text-white">{question.title}</p>
              )}
